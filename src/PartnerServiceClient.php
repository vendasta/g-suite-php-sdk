...
use Vendasta\GSuite\V1\internal\PartnerServiceGeneratedClient;

class PartnerServiceClient extends PartnerServiceGeneratedClient
{
    /**
     * PartnerServiceClient constructor.
